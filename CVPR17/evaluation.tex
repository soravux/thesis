...
\centering
\footnotesize
\includegraphics[width=\linewidth]{figures/validation-sun360/rmse-horiz.pdf} \\
(a) RMSE
\includegraphics[width=\linewidth]{figures/validation-sun360/rmse-si-horiz.pdf} \\
(b) Scale-invariant RMSE
\includegraphics[width=\linewidth]{figures/validation-sun360/rmse-si-rgb-horiz.pdf} \\
