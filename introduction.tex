...
\blockquote{\textbf{Single-Day Photometric Stereo} We present a systematic analysis of the expected performance of PS algorithms in outdoor settings on a single day or less, and then propose approaches to solve the single-day PS problem under various weather conditions.}
...
\blockquote{\textbf{Single Image Lighting and Camera Calibration} We present two learning-based approaches to perform outdoor lighting and camera calibration.}
