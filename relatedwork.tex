...
In this section, we will focus on outdoor illumination models. First, the most notable analytical and physically-based sky models are described, followed by algorithms to estimate their calibration. Finally, we cover related inverse rendering approaches.

\subsection{Analytical outdoor illumination models}

Analytical sky models are composed of a single empirically-derived closed-form equation to obtain the luminance of the sky. While they are typically used for rendering and for real-time applications because of their high evaluation speed, their accuracy is somewhat worse than physically-based models, giving skies that agrees less with real skies measurements.
