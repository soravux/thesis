...
\begin{equation}
Y_z = \underbrace{\left( 1 + A e^{\nicefrac{B}{\cos\theta}} \right)}_{\text{geometry factor}} \cdot \underbrace{\left( 1 + C e^{D\gamma} + E \cos^2 \gamma \right)}_{\text{indicatrix function}} \;.
\label{eq:perez}
\end{equation}
