...
Preetham et al.~\cite{preetham-siggraph-99} proposed to reduce this number of coefficients down to a single value, Linke's turbidity~\cite{mccartney1976optics}. This parameter is defined as
\begin{equation}
T = \frac{t_m + t_h}{t_m} \;,
\end{equation}
